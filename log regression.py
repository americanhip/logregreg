...
x_pick = data.drop(['dmHHS', 'dNAHS', 'dHOS', 'dVAS'], axis = 1)
ml('mHHS')
...
# headers = ['Side_L_True', 'WC', 'Age at Sx', 'Sex', 'BMI', 'Pre mHHS', 'Pre NAHS', 'Pre HOS-SSS', 'Pre VAS', 'MRI Femoral Version value', 'MRI Labral tear', 'MRI Ligamentum teres tear', 'MRI AVN', 'MRI Gluteus medius pathology', 'MRI Generalized chondral damage', 'MRI Localized chondral defect (not degenerative)', 'MRI Subchondral cyst - Femur central compartment', 'MRI Subchondral cyst - Femur peripheral compartment', 'MRI Subchondral cyst - Acetabulum central compartment', 'MRI Perilabral cyst', 'MRI Capsular Laxity', 'Ischial Spine (Pre-op)', 'Crossover (Pre-op)', 'Lateral CEA (Pre-op)', 'Acetabular Inclination (Pre-op)', 'Joint Space - Medial (Pre-op)', 'Joint Space - Central (Pre-op)', 'Joint Space - Lateral (Pre-op)', 'Neck-Shaft Angle (Pre-op)', 'Coxa Profunda (Pre-op)', 'Anterior CEA (Pre-op)', 'Alpha Angle (Pre-op)', 'Femoral Offset (Pre-op)', 'Flexion', 'IR', 'ER', 'Abduction', 'Lateral Imping', 'Internal Snapping', 'External Snapp', 'Anterior Impinge_1', 'Anterior Impinge_2'] 
